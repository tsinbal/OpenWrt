...
git clone --depth=1 https://github.com/tsinbal/packages_lang_golang -b 23.x feeds/packages/lang/golang
...
# Alist
git clone --depth=1 -b v3.35.0 https://github.com/sbwml/luci-app-alist package/luci-app-alist
